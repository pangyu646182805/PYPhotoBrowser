package com.neurotech.photobrowser.ui.widget.dialog.base;
...
public abstract class BaseDialog<T extends BaseDialog<T>> extends Dialog {
    ...
    public T setLeftButtonText(String leftButtonText) {
        return setText(R.id.btn_left, leftButtonText);
    }
    ...
    public T setRightButtonText(String rightButtonText) {
        return setText(R.id.btn_right, rightButtonText);
    }

    public T setOnLeftBtnClickListener(OnDialogClickListener<T> onLeftBtnClickListener) {
        if (onLeftBtnClickListener == null) {
            getView(R.id.btn_left).setOnClickListener(view -> dismissDialog());
        } else {
            getView(R.id.btn_left).setOnClickListener(view -> {
                onLeftBtnClickListener.onClick((T) this, view);
            });
        }
        return (T) this;
    }
    ...
    public T setOnRightBtnClickListener(OnDialogClickListener<T> onRightBtnClickListener) {
        if (onRightBtnClickListener == null) {
            getView(R.id.btn_right).setOnClickListener(view -> dismissDialog());
        } else {
            getView(R.id.btn_right).setOnClickListener(view -> {
                onRightBtnClickListener.onClick((T) this, view);
            });
        }
        return (T) this;
    }

    public T setLeftBtn(String text, OnDialogClickListener<T> dialogClickListener) {
        setLeftButtonText(text);
        return setOnLeftBtnClickListener(dialogClickListener);
    }

    public T setRightBtn(String text, OnDialogClickListener<T> dialogClickListener) {
        setRightButtonText(text);
        return setOnRightBtnClickListener(dialogClickListener);
    }
